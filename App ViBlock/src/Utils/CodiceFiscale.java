...
public class CodiceFiscale {
        ...
        public CodiceFiscale(Person person) throws IOException {
        ...
        public String getCode(){
            return codiceCitta().equals(UtilsCF.ERROR) ? "*#ERRORE DI CALCOLO#*" : code;
        }
        ...
        private String codiceCitta() {
            return UtilsCF.getCitiesCodes().getKey(citta);
        }
