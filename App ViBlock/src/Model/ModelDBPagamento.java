...
public class ModelDBPagamento implements ModelPagamento{
    ...
    public void insertNewPayment(Pagamento payment) {
        ...
        if(payment.getMembership().equalsIgnoreCase("NO") && payment.getShoes().equalsIgnoreCase("NO"))
            ...
            "VALUES (CURRENT_TIMESTAMP, ?::NUMERIC(6,2), ?, ?, ?, null, ?, null, ?); ", List.of(payment.getAmount().toString(),payment.getPaymentType(), payment.getEnterType(),
            ...
            db.executeSQLUpdate("INSERT INTO pagamento(istantepagamento, importo, tipopagamento, ingresso, tesseramento, prezzotesseramento, scarpette, prezzoscarpette, cfutente)" +
                    "VALUES (CURRENT_TIMESTAMP, ?::NUMERIC(6,2), ?, ?, ?, null, ?, ?::NUMERIC(6,2), ?); ", List.of(payment.getAmount().toString(),payment.getPaymentType(), payment.getEnterType(),
            ...
            db.executeSQLUpdate("INSERT INTO pagamento(istantepagamento, importo, tipopagamento, ingresso, tesseramento, prezzotesseramento, scarpette, prezzoscarpette, cfutente)" +
                    "VALUES (CURRENT_TIMESTAMP, ?::NUMERIC(6,2), ?, ?, ?, ?::NUMERIC(6,2), ?, null, ?); ", List.of(payment.getAmount().toString(),payment.getPaymentType(), payment.getEnterType(),
                    payment.getMembership(), payment.getPriceMembership().toString(), payment.getShoes(), payment.getCfPerson()));
        else
            db.executeSQLUpdate("INSERT INTO pagamento(istantepagamento, importo, tipopagamento, ingresso, tesseramento, prezzotesseramento, scarpette, prezzoscarpette, cfutente)" +
                    "VALUES (CURRENT_TIMESTAMP, ?::NUMERIC(6,2), ?, ?, ?, ?::NUMERIC(6,2), ?, ?::NUMERIC(6,2), ?); ", List.of(payment.getAmount().toString(),payment.getPaymentType(), payment.getEnterType(),
